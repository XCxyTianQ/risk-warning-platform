...
| 模型 | 关键指标 | 用时(s) |
|---|---|---:|
| gpt-6-astra | multimodal.overall=71.33%(n=150); multimodal.byFintype.__ALL__=71.33%(n=150); multimodal.byFintype.FinEval-MM/金融市场情绪洞察=80%(n=5); multimodal.byFintype.FinEval-MM/金融情景分析=71.43%(n=14); multimodal.byFintype.FinEval-MM/产业分析推断=100%(n=9); multimodal.byFintype.FinEval-MM/投资分析=71.43%(n=7); multimodal.byFintype.FinEval-MM/股票k线解读=73.33%(n=15) | 182.4 |
