...
| 模型 | 关键指标 | 用时(s) |
|---|---|---:|
| claude-fable-5-1 | judgeGraded.byMode.__ALL__=90.67%(n=300); judgeGraded.byMode.oracle=94.67%(n=150); judgeGraded.byMode.closedBook=86.67%(n=150); deterministic.byMode.oracle=35.33%(n=150); deterministic.byMode.closedBook=34.67%(n=150); byQuestionType.__ALL__=94.67%(n=150); byQuestionType.FinanceBench/metrics-generated=98%(n=50) | 569.9 |
